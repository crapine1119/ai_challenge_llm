<template>
  <header class="border-b bg-white">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
      <router-link to="/" class="font-semibold">Job Korea JD Generator (beta) </router-link>

      <nav class="flex items-center gap-4 text-sm">
        <router-link to="/analyze">직무 분석</router-link>
        <router-link to="/generate/realtime">실시간 생성</router-link>
        <router-link to="/collect">직무 등록</router-link>
        <router-link to="/404">갤러리 (TODO)</router-link>
